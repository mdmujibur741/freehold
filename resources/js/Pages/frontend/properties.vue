                ...
                <div class="container">
                    <div class="row mb-4">
                        <div class="col-12 text-center">
                            <h3 class="mb-5" spellcheck="false">ALL PROPERTY</h3>
                        </div>
                                        ...
                                        <div class="col-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <h6 class="font-weight-bolder mb-0"> {{property.bed.bed}} </h6>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <h6 class="font-weight-bolder mb-0"> {{property.shower.shower}} </h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row mb-4">
                        <div class=" p-3 text-center">
                            <Link
                               ...
                               v-for="link in properties.meta.links" :href="link.url" v-html="link.label" />
