                  ...
                  <div class="card-body">
                    ...
                    <form @submit.prevent="submit">
                      ...
                      <div class="mb-2">
                        ...
                        <TextInput id="name" type="file" v-model="form.logo"
                           />
                      ...
                      <div class="mb-2">
                        <InputLabel for="bg_image" value="Background Image" />
                        <TextInput id="bg_image" type="file" v-model="form.bg_image"
                           />
                        <InputError class="mt-2 text-red" :message="form.errors.bg_image" />
                      </div>
