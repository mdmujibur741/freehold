      ...
      <AuthenticatedLayout>
         <div class="py-6">
            ...
            <div class="text-end px-8 ">
                <Link :href="route('admin.city.create')" class="text-white bg-blue-700 px-3 py-2 rounded-full">Add City</Link>
            </div>
            ...
            <div class="overflow-x-auto relative m-7">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 rounded-lg border-collapse border border-slate-400">
                    ...
                    <tbody >
                       ...
                       <Link :href="route('admin.city.edit', city.id)" class="p-2 bg-blue-400 rounded-full text-white mx-2">Edit</Link>
                       <Link :href="route('admin.city.destroy', city.id)" method="delete" as="button" type="button" onclick="return confirm('Are you sure you want to delete this item')" class="p-2 bg-blue-400 rounded-full text-white mx-2">Delete</Link>
