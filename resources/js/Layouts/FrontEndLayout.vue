          ...
          <div class="collapse navbar-collapse w-100 pt-3 pb-2 py-lg-0" id="navigation">
              <ul class="navbar-nav navbar-nav-hover ms-auto">
                  <li class="nav-item mx-2">
                      <Link :href="route('web.home')" class="nav-link px-2 rounded-3 cursor-pointer active">
                         <b> Home</b>
                      </Link>
                  </li>
                  <li class="nav-item mx-2">
                      <Link :href="route('web.properties')" class="nav-link ps-2 cursor-pointer rounded-3"><b>Properties</b></Link>
                  </li>
                  <li class="nav-item mx-2">
                      <Link :href="route('web.contact')" class="nav-link ps-2 cursor-pointer rounded-3">
                         <b> Contact Us</b>
                      </Link>
                  </li>
              </ul>
